...
export function InfoWindowContent({ place, onSave }: InfoWindowContentProps) {
  ...
  return `
    <div style="padding: 8px; max-width: 300px;">
      ...
      <button 
        id="${saveButtonId}"
        onclick="window.handleSaveLocation('${place.place_id}')"
        style="
          margin-top: 12px;
          padding: 8px 16px;
    ...
    <script>
      (function() {
        ...
        if (button) {
          ...
          window.handleSaveLocation = function(placeId) {
